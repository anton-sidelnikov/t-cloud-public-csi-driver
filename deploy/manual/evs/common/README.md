# EVS Common Manual Test Manifests

This folder contains the common EVS manual validation scenarios.

Apply the bundle:

```bash
kubectl apply -k deploy/manual/evs/common
```
...
```bash
kubectl delete -k deploy/manual/evs/common
```
